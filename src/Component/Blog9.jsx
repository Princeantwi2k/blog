...
const Blog9 = ({ speaker }) => {
  ...
  let [product] = speaker.filter((speaker) => speaker.id === id);
        ...
        <Row>
          ...
          <Col sm={5} md={5} className="productName">
            ...
            <div>
              ...
              <BsFillStarFill className="blogicon" />
              <BsFillStarFill className="blogicon" />
              <BsStarHalf className="blogicon" />
              (605 Verified Product Ratings)
            </div>
          ...
          <Col sm={2} md={3} className="over">
            ...
            <p>
              Free shipping on Bluelet Express orders above GH¢125 in Accra
...
export default connect(mapStateToprops)(Blog9);
